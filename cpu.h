...
enum OPCODES{ 
    ...
    RZ      = 0x88, RET     = 0x89, JZ      = 0x8a, /*JMP*    0xDD*/CZ      = 0x8c, CALL    = 0x8d, ACI     = 0x8e, RST_1   = 0x8f,
    RC      = 0x98, /*RET*    0xDD*/JC      = 0x9a, IN      = 0x9b, CC      = 0x9c, /*CALL*   0xDD*/SBI     = 0x9e, RST_3   = 0x9f,
    RPE     = 0xa8, PCHL    = 0xa9, JPE     = 0xaa, XCHG    = 0xab, CPE     = 0xac, /*CALL*   0xDE*/XRI     = 0xae, RST_5   = 0xaf,
    RM      = 0xb8, SPHL    = 0xb9, JM      = 0xba, EI      = 0xbb, CM      = 0xbc, /*CALL*   0xDF*/CPI     = 0xbe, RST_7   = 0xbf,
};